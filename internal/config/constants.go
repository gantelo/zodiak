...
const START_DAILY_BESTAT_TASK_HOUR = "15:15"
...
const BESTAT_TITLE_SIZE = 28
const BESTAT_MAX_FONT_SIZE = 28
const BESTAT_MED_FONT_SIZE = 24
const BESTAT_MIN_FONT_SIZE = 19
